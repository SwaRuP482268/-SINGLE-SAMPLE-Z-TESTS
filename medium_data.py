...
mean_t=statistics.mean(data)
stdev_t=statistics.stdev(data)

print('Mean and Stdev are {}, {} respectively'.format(mean_t,stdev_t))
...
def show_fig(data,sampling_stdev):
    ...
    z_score=(sampling_mean-mean_t)/stdev_t
